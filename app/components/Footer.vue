     ...
     <footer class="bg-gray-900 text-white py-16">
      <div class="container mx-auto px-6">
        <div class="grid md:grid-cols-4 gap-8">
          <div>
            <div class="flex items-center mb-6">
              <img
                height="50"
                width="50"
                src="/images/climate-walker-logo.png"
                alt="climate-walker"
              />
              <span class="text-2xl ml-5 font-bold flex flex-col">
                ...
                <a
                  ...
                  class="text-climate-green text-sm hover:text-green-400"
                >
          ...
          <div>
            <h4 class="font-bold text-lg mb-4 text-purple-400">Journey</h4>
            ...
            <ul class="space-y-3 text-gray-400">
              ...
              <li>
                <a
                  ...
                  class="hover:text-green-400 transition-colors flex items-center gap-2"
                >
                  <svg class="w-5 h-5" fill="white" viewBox="0 0 24 24">
                    <path
        ...
        >
          ...
          <p class="mt-2">
            &copy; 2025 Climate Walker. Every step counts towards a sustainable
            future.
          </p>
        </div>
      </div>
